...
function pauseRecording() {
    ...
    if (rec.recording) {
        //pause
        rec.stop();
        pauseButton.innerHTML = "<i class='fas fa-3x fa-pause'></i>Resume";
    } else {
        //resume
        rec.record()
        pauseButton.innerHTML = "<i class='fas fa-3x fa-pause'></i>Pause";
...
function createDownloadLink(blob) {
    ...
    // link.innerHTML = "<br><small>download<small>";
